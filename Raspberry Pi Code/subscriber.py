...
AWS_IOT_TOPIC = "core/motion"
AWS_IOT_ENDPOINT = "XXXXXXXXX.iot.us-west-2.amazonaws.com"
...
def on_message(client, userdata, msg):
    ...
    print(tev_json_obj["coordinates"]["xAxis"])
    print(tev_json_obj["coordinates"]["yAxis"])
    print(tev_json_obj["coordinates"]["zAxis"])
    print('######################')
...
if __name__ == "__main__":
    ...
    schedule.every(0.1).minutes.do(lambda: go_to_sleep(activy));
